#!/usr/bin/env python3
"""Launch LD06 with its standalone RViz view."""
...
def generate_launch_description():
    ...
    driver = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(package + '/launch/ld06.launch.py'),
        launch_arguments={'publish_tf': 'true'}.items(),
    )
    rviz = Node(
        package='rviz2', executable='rviz2', name='rviz2_show_ld06',
